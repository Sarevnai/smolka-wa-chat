...
import { Search, User, Loader2, Edit } from "lucide-react";
import { useContacts } from "@/hooks/useContacts";
import { useUpdateContactList, ContactList } from "@/hooks/useContactLists";
...
export default function EditContactListModal({
  open,
  onOpenChange,
  list,
  onSuccess,
  ...
  const [selectedContacts, setSelectedContacts] = useState<Set<string>>(new Set(list.contact_ids));
  ...
  useEffect(() => {
    ...
    setSelectedContacts(new Set(list.contact_ids));
  }, [list]);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-lg max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Atualize o nome, descrição ou contatos da lista
          </DialogDescription>
        </DialogHeader>
